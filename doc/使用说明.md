...
关于 idea 插件开发官方文档：https://jetbrains.org/intellij/sdk/docs/basics/basics.html



images目录下的两个icon，分别是decompile.svg和decompile_dark.svg，分别用于普通模式和dark模式。需要制作一个识别度高的svg图片。